...
def get_test_prf(handshaking_tagger, metrics, pred_sample_list, gold_test_data, pattern="only_head_text"):
    text_id2gold_n_pred = {}
...
def main():
    ...
    if score:
        ...
        for file_path, pred_samples in res_dict.items():
            ...
            prf = get_test_prf(handshaking_tagger, metrics,
                               pred_samples, gold_test_data, pattern=correct)
